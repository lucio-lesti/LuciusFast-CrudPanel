      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"> Dimensioni tabella registro di backup:
              <?php
            ...
            <div class="pull-right">
              <a class="btn btn-danger" href="<?php echo base_url(); ?>backupLogTableDelete">Cancella tabella di backup</a>
            </div>
            <div class="box-tools">
            </div>
          </div>
