...
<html>
   <head>
      <meta charset="UTF-8">
      <title>Pagamenti/Ricevute</title>
 <style>
		html { 
			margin-bottom: 10px;
			margin-top: 40px;
			...
			<table style="width:99%"  border=0>
				<tr>
					...
					<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
						...
						<input type="text" class="form-control"  name="fk_disciplina" id="fk_disciplina" value="<?php echo $fk_disciplina; ?>" />
	 
					</div><p style="clear: left;" /></p>
	 
					<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
	
						<label for="varchar">Importo </label>	
						<input type="text" class="form-control"  name="importo" id="importo"  value="<?php echo $importo; ?>" />
					...
					<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
						...
						<input type="text" class="form-control"  name="data" id="data"  value="<?php echo $data; ?>" />
	 
					</div><p style="clear: left;" /></p>
	 
					<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
	
						<label for="enum">Mese <?php echo form_error('mese') ?></label>	
						<input type="text" class="form-control"  name="mese" id="mese" value="<?php echo $mese; ?>" />
	 
					</div>
	 
					<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
	
						<label for="enum">Anno <?php echo form_error('anno') ?></label>	
						<input type="text" class="form-control"  name="anno" id="anno" value="<?php echo $anno; ?>" />
