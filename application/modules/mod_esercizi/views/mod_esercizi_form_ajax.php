	    ...
	    <div class="form-group">
							...
							<input type="text" class="form-control datemask" name="data_da" id="data_da" placeholder="Da Data" 
								autocomplete="off" style="background-color:#FFFFFF"  value="<?php echo $data_da; ?>" />
						</div></div></div><div class="col-md-4">
	    <div class="form-group">
							<label for="date"><b style="color:#990000">(*)</b>A Data <?php echo form_error('data_a') ?></label>
											<div class="input-group">
												<div class="input-group-addon"><i class="fa fa-calendar"></i></div>			
							<input type="text" class="form-control datemask" name="data_a" id="data_a" placeholder="A Data" 
								autocomplete="off" style="background-color:#FFFFFF"  value="<?php echo $data_a; ?>" />
						</div></div></div>
...
<?php } ?>
		...
		<?php
			if($type_action == 'create'){
				$ajaxAction = 'mod_esercizi/create_action';
			} else {
				$ajaxAction = 'mod_esercizi/update_action';
		...
		<script>
			...
			arrayValidationFields['winMasterDetail_mod_anagrafica_tessere_interne']['fk_anagrafica']['label'] = "Alunno"
