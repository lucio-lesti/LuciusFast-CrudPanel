<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Esercizi 
				  <?php 
				  	if($perm_write == 'Y'){
			  		?>				  
					<a class="btn btn-primary" onclick="createAjax('mod_esercizi')">
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_esercizi","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_esercizi";
				
objAjaxConfig.mod_title = "Esercizi";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_esercizi_nome"};	
columnArray[2] = {type:"date", name:"mod_esercizi_data_da"};	
columnArray[3] = {type:"date", name:"mod_esercizi_data_a"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_esercizi_nome"},
{"data": "mod_esercizi_data_da"},
{"data": "mod_esercizi_data_a"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_esercizi',".$_REQUEST['id'].");";
}
?>
</script>
