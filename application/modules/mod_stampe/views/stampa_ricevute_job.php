...
?>
 ...
 <BR>
	...
	La somma di Euro <b class="dottedUnderline"><?php echo $value['importo']?></b>
	</P>
	<P STYLE="margin-bottom: 0.11in"><FONT FACE="Calibri,Bold, serif">Quale
	corrispettivo specifico per l'attività di</FONT> <U></U> <b class="dottedUnderline"><?php echo $value['corso']?></b> <FONT FACE="Calibri,Bold, serif">volta
