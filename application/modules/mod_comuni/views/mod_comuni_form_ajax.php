	    ...
	    <div class="form-group">
									<label for="varchar"><b style="color:#990000">(*)</b>ID Comune <?php echo form_error('comune') ?></label>
													<div class="input-group">
														<div class="input-group-addon"><i class="fa fa-text-height"></i></div>			
									<input type="text" readonly="readonly" class="form-control" maxlength='100' name="comune_istat" id="comune_istat" placeholder="Comune" autocomplete="off" value="<?php echo $istat; ?>" />
									</div></div></div>					
...
<?php } ?>
		...
		<?php
			if($type_action == 'create'){
				$ajaxAction = 'mod_comuni/create_action';
			} else {
				$ajaxAction = 'mod_comuni/update_action';
