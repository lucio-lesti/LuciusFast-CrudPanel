					...
					<table style="width:99%"  border=0>
						<tr>
							...
							<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
								...
								<label for="int">Azienda <?php echo form_error('fk_azienda') ?></label>	
								<input type="text" class="form-control"  name="fk_azienda" id="fk_azienda" value="<?php echo $fk_azienda; ?>" />
	 
							</div>
	 
							<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
	
								<label for="varchar">Indirizzo </label>	
							...
							<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
								...
								<label for="varchar">Nome Sede </label>	
