<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Sedi 
				  <?php 
				  	if($perm_write == 'Y'){
			  		?>				  
					<a class="btn btn-primary" onclick="createAjax('mod_sedi')">
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_sedi","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_sedi";
				
objAjaxConfig.mod_title = "Sedi";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_sedi_nome"};	
columnArray[2] = {type:"text", name:"mod_sedi_indirizzo"};	
columnArray[3] = {type:"text", name:"core_settings_company_name"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_sedi_nome"},
{"data": "mod_sedi_indirizzo"},
{"data": "core_settings_company_name"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_sedi',".$_REQUEST['id'].");";
}
?>
</script>
