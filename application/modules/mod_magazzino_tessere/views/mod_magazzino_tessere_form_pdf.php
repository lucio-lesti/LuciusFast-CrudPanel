					...
					<table style="width:99%"  border=0>
						<tr>
							...
							<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
								...
								<label for="varchar">Nome Magazzino </label>	
							...
							<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
								...
								<label for="int">Affiliazione <?php echo form_error('fk_affiliazione') ?></label>	
								<input type="text" class="form-control"  name="fk_affiliazione" id="fk_affiliazione" value="<?php echo $fk_affiliazione; ?>" />
