<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Magazzino Tessere		  
			<?php 
				if($perm_write == 'Y'){
				?>				  
			  <a class="btn btn-primary" onclick="createAjax('mod_magazzino_tessere')">
			  ...
			  ?>	
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_magazzino_tessere","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_magazzino_tessere";
				
objAjaxConfig.mod_title = "Magazzino Tessere";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_magazzino_tessere_nome"};	
columnArray[2] = {type:"text", name:"mod_affiliazioni_nome"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_magazzino_tessere_nome"},
{"data": "mod_affiliazioni_nome"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_magazzino_tessere',".$_REQUEST['id'].");";
}
?>
</script>
