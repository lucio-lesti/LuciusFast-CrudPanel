<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-copy"></i> Affiliazioni		  
			<?php 
				if($perm_write == 'Y'){
				?>				  
			  <a class="btn btn-primary" onclick="createAjax('mod_affiliazioni')">
			  ...
			  ?>	
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_affiliazioni","deleteMassive")'>
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs" id="tab-menu">
				  <li class="active"><a href='#elenco' id='href_elenco' data-toggle="tab" aria-expanded="true"></i><i class="fa fa-list-ol"></i> Elenco  <i class='fa fa-copy'></i></a></li>
				</ul>  
...
objAjaxConfig.mod_name = "mod_affiliazioni";
				
objAjaxConfig.mod_title = "Affiliazioni";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_affiliazioni_nome"};	
columnArray[2] = {type:"text", name:"mod_enti_nome"};	
columnArray[3] = {type:"text", name:"mod_esercizi_nome"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_affiliazioni_nome"},
{"data": "mod_enti_nome"},
{"data": "mod_esercizi_nome"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_affiliazioni',".$_REQUEST['id'].");";
}
?>
</script>
