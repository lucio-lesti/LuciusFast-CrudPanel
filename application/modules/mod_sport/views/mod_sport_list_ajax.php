<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Sports		  
			<?php 
				if($perm_write == 'Y'){
				?>				  
			  <a class="btn btn-primary" onclick="createAjax('mod_sport')">
			  ...
			  ?>	
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_sport","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_sport";
				
objAjaxConfig.mod_title = "Sports";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_sport_sport"};	
var columnGrid = [
...
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_sport',".$_REQUEST['id'].");";
}
?>
</script>
