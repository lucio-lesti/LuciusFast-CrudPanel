<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Documenti Spese Generiche		  
			<?php 
				if($perm_write == 'Y'){
				?>				  
			  <a class="btn btn-primary" onclick="createAjax('mod_doc_spese_generiche')">
			  ...
			  ?>	
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_doc_spese_generiche","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_doc_spese_generiche";
				
objAjaxConfig.mod_title = "Documenti Spese Generiche";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_doc_spese_generiche_nome"};	
columnArray[2] = {type:"date", name:"mod_doc_spese_generiche_data"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_doc_spese_generiche_nome"},
{"data": "mod_doc_spese_generiche_data"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_doc_spese_generiche',".$_REQUEST['id'].");";
}
?>
</script>
