...
class Mod_tesseramenti_model extends BaseModel
{
	...
	public function __construct(){
		...
		$this->setFieldArrayGrid('data_tesseramento', FIELD_DATE);
		$this->setFieldArrayGrid('fk_affiliazione',FIELD_NUMERIC,'mod_affiliazioni',array("id" => 'id', "nome" => 'nome'));
		$this->setFieldArrayGrid('fk_anagrafica',FIELD_NUMERIC,'mod_anagrafica',array("id" => 'id', "nome" => array("nome"," ","cognome"," ' - ' ","codfiscale") ),'nome');
		$this->setFieldArrayGrid('fk_esercizio',FIELD_NUMERIC,'mod_esercizi',array("id" => 'id', "nome" => 'nome'));
		$this->setFieldArrayGrid('fk_tessera_associativa',FIELD_NUMERIC,'_mod_magazzino_tessere_lista_tessere',array("id" => 'id', "nome" => 'codice_tessera'));
		$this->setFieldArrayGrid('tessera_interna',FIELD_NUMERIC);
		$this->setFieldArrayGrid('importo', FIELD_FLOAT);
		//$this->setFieldArrayGrid('modo_pagamento', FIELD_STRING);
		...
		$this->arrayColumnsReferenced['_mod_magazzino_tessere_lista_tessere']['nome'] = "codice_tessera"; 
