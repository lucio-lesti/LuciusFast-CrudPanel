<!DOCTYPE html>
		<html>
		   <head>
			  <meta charset="UTF-8">
			  <title>Documenti Generici</title>
		 <style>
				html { 
					margin-bottom: 10px;
					margin-top: 40px;
					...
					<table style="width:99%"  border=0>
						<tr>
							...
							<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
								...
								<textarea class="form-control" rows="3" name="descrizione" id="descrizione"  ><?php echo $descrizione; ?></textarea>
	 
							</div>
	 
							<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
	
								<label for="varchar">Nome </label>	
							...
							<div class="col-md-4"  style="float: left; width: 32%;padding-bottom:5px">
								...
								<label for="enum">Tipo Doc <?php echo form_error('tipo_doc') ?></label>	
