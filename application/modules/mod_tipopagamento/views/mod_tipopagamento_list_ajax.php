<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Tipo Pagamento 
				  <?php 
				  	if($perm_write == 'Y'){
			  		?>				  
					<a class="btn btn-primary" onclick="createAjax('mod_tipopagamento')">
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_tipopagamento","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_tipopagamento";
				
objAjaxConfig.mod_title = "Tipo Pagamento";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_tipopagamento_codice"};	
columnArray[2] = {type:"text", name:"mod_tipopagamento_nome"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_tipopagamento_codice"},
{"data": "mod_tipopagamento_nome"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_tipopagamento',".$_REQUEST['id'].");";
}
?>
</script>
