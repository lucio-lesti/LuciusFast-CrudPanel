	    ...
	    <div class="form-group">
									...
									<input type="text" class="form-control" maxlength='10' name="codice" id="codice" placeholder="Codice" autocomplete="off" value="<?php echo $codice; ?>" />
									</div></div></div><div class="col-md-4">
	    <div class="form-group">
									<label for="varchar"><b style="color:#990000">(*)</b>Descrizione <?php echo form_error('nome') ?></label>
													<div class="input-group">
														<div class="input-group-addon"><i class="fa fa-text-height"></i></div>			
									<input type="text" class="form-control" maxlength='255' name="nome" id="nome" placeholder="Descrizione" autocomplete="off" value="<?php echo $nome; ?>" />
									</div></div></div>
...
<?php } ?>
		...
		<?php
			if($type_action == 'create'){
				$ajaxAction = 'mod_tipopagamento/create_action';
			} else {
				$ajaxAction = 'mod_tipopagamento/update_action';
