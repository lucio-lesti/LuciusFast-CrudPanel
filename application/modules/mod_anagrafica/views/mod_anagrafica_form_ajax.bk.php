   						...
   						<div class="col-md-4">
   							...
   							<div class="form-group" id="<?php echo $dv_fk_tutore; ?>">
								...
								<div class="input-group">
									...
									<?php //echo "TUTORE:".$fk_tutore;?>
									<select class="form-control" 
										style="width:88%" id="fk_tutore" name="fk_tutore">
										<option value=""><option>
										<?php
		...
		function genTutore(){
   		...
   		function caricaTutori() {
   			...
   			$.ajax({
   				...
   				success: function(jsonData) {
					$('#fk_tutore').select2('destroy');
					//$("#fk_tutore option").remove(); 
					$('#fk_tutore').append('<option value=""></option>');
   					for (var i = 0; i < jsonData.length; i++) {
   						$('#fk_tutore').append('<option value="' + jsonData[i].id + '">' + jsonData[i].nome + '</option>');
  ...
  <div class="modal-dialog" role="document" style="width: 60%; max-width: 70%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<br><input type=button value="Scatta Foto" onClick="take_snapshot()">
		...
		<div class="modal-footer">
			<div id="dv_delete_allegato_blob" style="float: right;"><button onclick="setFoto()" type="button" class="btn btn-info" id="bt_delete_allegato_blob" >IMPOSTA FOTO</button></div>
