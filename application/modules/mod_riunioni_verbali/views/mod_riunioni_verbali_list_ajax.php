<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Verbali riunioni		  
			<?php 
				if($perm_write == 'Y'){
				?>				  
			  <a class="btn btn-primary" onclick="createAjax('mod_riunioni_verbali')">
			  ...
			  ?>	
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_riunioni_verbali","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_riunioni_verbali";
				
objAjaxConfig.mod_title = "Verbali riunioni";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_riunioni_verbali_oggetto"};	
columnArray[2] = {type:"date", name:"mod_riunioni_verbali_data_riunione_verbale"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_riunioni_verbali_oggetto"},
{"data": "mod_riunioni_verbali_data_riunione_verbale"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_riunioni_verbali',".$_REQUEST['id'].");";
}
?>
</script>
