<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Sale		  
			<?php 
				if($perm_write == 'Y'){
				?>				  
			  <a class="btn btn-primary" onclick="createAjax('mod_sale')">
			  ...
			  ?>	
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_sale","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_sale";
				
objAjaxConfig.mod_title = "Sale";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_sale_nome"};	
columnArray[2] = {type:"text", name:"mod_sedi_nome"};	
columnArray[3] = {type:"number", name:"mod_sale_capienza"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_sale_nome"},
{"data": "mod_sedi_nome"},
{"data": "mod_sale_capienza"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_sale',".$_REQUEST['id'].");";
}
?>
</script>
