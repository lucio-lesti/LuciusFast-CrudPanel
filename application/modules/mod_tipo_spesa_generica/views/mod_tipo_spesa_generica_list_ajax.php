<!-- INIZIO-->
			...
			<div class="content-wrapper">
			  ...
			  <section class="content-header">
				...
				<h1>
				  <i class="fa fa-cubes"></i> Tipo Spesa 
				  <?php 
				  	if($perm_write == 'Y'){
			  		?>				  
					<a class="btn btn-primary" onclick="createAjax('mod_tipo_spesa_generica')">
					...
					<button class="btn btn-sm btn-danger deleteUser" disabled="disabled" id="btDeleteMass" name="btDeleteMass" 
						onclick='deleteMassiveEntry("entry_list", "check_id", "mod_tipo_spesa_generica","deleteMassive")'>
...
objAjaxConfig.mod_name = "mod_tipo_spesa_generica";
				
objAjaxConfig.mod_title = "Tipo Spesa";				
				
var columnArray = [];
columnArray[1] = {type:"text", name:"mod_tipo_spesa_generica_nome"};	
var columnGrid = [
{"data": "ids","orderable": false},
{"data": "mod_tipo_spesa_generica_nome"},
{"data": "action","orderable": false,"className": "text-center"}
];
<?php
if(isset($_REQUEST['id'])){
	echo "editAjax('mod_tipo_spesa_generica',".$_REQUEST['id'].");";
}
?>
</script>
