	    ...
	    <div class="form-group">
									<label for="varchar"><b style="color:#990000">(*)</b>Causale Pagamento <?php echo form_error('nome') ?></label>
													<div class="input-group">
														<div class="input-group-addon"><i class="fa fa-text-height"></i></div>			
									<input type="text" class="form-control" maxlength='50' name="nome" id="nome" placeholder="Causale Pagamento" autocomplete="off" value="<?php echo $nome; ?>" />
									</div></div></div>
...
<?php } ?>
		...
		<?php
			if($type_action == 'create'){
				$ajaxAction = 'mod_causali_pagamento/create_action';
			} else {
				$ajaxAction = 'mod_causali_pagamento/update_action';
